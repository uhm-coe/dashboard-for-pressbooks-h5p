...
class Settings extends Static_Instance {
	...
	public function render_settings_page() {
		...
		<div class="wrap">
			...
			<ol>
				<li>
					<a target="_blank" href="<?php echo esc_attr( admin_url( 'admin.php?page=pb_organize' ) ); ?>"><?php esc_html_e( 'Chapter Badges in Dashboard > Organize', 'p22d' ); ?></a><br>
				...
				<li>
					<a target="_blank" href="<?php echo esc_attr( site_url() ); ?>"><?php esc_html_e( 'Chapter Badges in Table of Contents', 'p22d' ); ?></a><br>
				...
				<li>
					<a target="_blank" href="<?php echo esc_attr( admin_url( '#p22d_dashboard_widget' ) ); ?>"><?php esc_html_e( 'Dashboard Widget', 'p22d' ); ?></a><br>
				...
				<li>
					<a href="<?php echo esc_attr( '#option_hide_h5p_for_anonymous_users' ); ?>"><?php esc_html_e( 'Hide H5P Content For Anonymous Users', 'p22d' ); ?></a><br>
